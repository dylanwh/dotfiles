...
syn keyword pgsqlKeyword	 update unique "primary key" unlisten using
...
syn region pgsqlName		 start=+"+  skip=+\\\\\|\\"+  end=+"+
...
syn keyword pgsqlType		 abstime aclitem  anyarray anyelement bigint bit bit varying bigint bigserial  serial
syn keyword pgsqlType		 boolean box bytea char varchar character "character varying" cid cidr circle cstring 
