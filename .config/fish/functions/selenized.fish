...
function selenized
    argparse 'v/variant=' 'g/global' -- $argv
    if [ -z $_flag_variant ]
    ...
    set $scope fish_color_autosuggestion $s_dim_0 brblack
    set $scope fish_color_cancel -r
    set $scope fish_color_command $s_br_yellow bryellow --bold
    set $scope fish_color_comment $s_dim_0 white -i --bold
    set $scope fish_color_cwd $s_br_blue brblue --bold
    set $scope fish_color_cwd_root $s_red red
    set $scope fish_color_end $s_green green
    set $scope fish_color_error $s_br_red brred
    set $scope fish_color_escape $s_red red
    set $scope fish_color_hg_added $s_green green
    set $scope fish_color_hg_clean $s_green green
    set $scope fish_color_hg_copied $s_magenta magenta
    set $scope fish_color_hg_deleted $s_red red
    set $scope fish_color_hg_dirty $s_red red
    set $scope fish_color_hg_modified $s_yellow yellow
    set $scope fish_color_hg_renamed $s_magenta magenta
    set $scope fish_color_hg_unmerged $s_red red
    set $scope fish_color_hg_untracked $s_yellow yellow
    set $scope fish_color_history_current --bold
    set $scope fish_color_host $s_fg_0 normal
    set $scope fish_color_host_remote $s_yellow yellow
    set $scope fish_color_match yellow --reverse
    set $scope fish_color_normal $s_fg_0 normal
    set $scope fish_color_operator $s_br_blue brblue
    set $scope fish_color_param $s_fg_1 white
    set $scope fish_color_quote $s_cyan cyan
    set $scope fish_color_redirection $s_br_violet brmagenta
    set $scope fish_color_search_match $s_br_yellow bryellow --background=$s_bg_2
    set $scope fish_color_selection $s_fg_1 white --background=$s_bg_2
    set $scope fish_color_status $s_orange red
    set $scope fish_color_user $s_br_green brgreen
    set $scope fish_color_valid_path $s_fg_1 white --underline
    set $scope fish_color_vcs $s_violet magenta
end
