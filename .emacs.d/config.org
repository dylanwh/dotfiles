...
#+END_SRC
** xterm-frobs
xterm-frobs sets window and icon titles.
#+BEGIN_SRC emacs-lisp
...
** bmo stuff
   ...
   - [[file:elisp/dylan-eshell-commands.el::(defun%20eshell/cdb%20(str)][eshell commands]]
...
#+BEGIN_SRC emacs-lisp
  ...
  (org-add-link-type "bmo" #'my-org-open-bmo #'my-org-format-bmo)
...
#+BEGIN_SRC emacs-lisp
  ...
  (global-set-key (kbd "C-c e") 'shell-switcher-switch-buffer)
  (global-set-key (kbd "C-c E") 'shell-switcher-new-shell)
