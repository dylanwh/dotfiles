...
** environmental variables
 #+BEGIN_SRC emacs-lisp
   ...
   (dolist (exec-path-dir (list (concat (getenv "HOME") "/bin") "/usr/bin" "/bin" "/usr/local/bin"))
     (unless (member exec-path-dir exec-path)
       (setq exec-path (cons  exec-path-dir exec-path))))
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package moe-theme :ensure t
    :config (load-theme 'moe-dark t t))
...
#+BEGIN_SRC emacs-lisp
  ...
  (defun my-projectile-eshell ()
    "Open `eshell' at the root of the project."
    (interactive)
...
#+BEGIN_SRC emacs-lisp
  (use-package evil
    ...
    (progn
      ...
      ;; (define-key evil-normal-state-map (kbd "SPC f") 'helm-find-file)
