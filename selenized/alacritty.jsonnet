  ...
  [
    {
      colors: {
        ...
        normal: {
          ...
          red: color(s_red),
          green: color(s_green),
          yellow: color(s_yellow),
          blue: color(s_blue),
          magenta: color(s_magenta),
          cyan: color(s_cyan),
          white: color(s_dim_0),
        },
        bright: {
          black: color(s_bg_2),
          red: color(s_br_red),
          green: color(s_br_green),
          yellow: color(s_br_yellow),
          blue: color(s_br_blue),
          magenta: color(s_br_magenta),
          cyan: color(s_br_cyan),
          white: color(s_fg_1),
        },
      },
      font: font,
